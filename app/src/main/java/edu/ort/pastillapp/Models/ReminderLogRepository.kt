...
class ReminderLogRepository(private val context: Context) {
    ...
    fun obtainReminderLog(
        reminderLogId: String,
        onSuccess: (ReminderLog) -> Unit,
        onError: (String) -> Unit
    ) {
        apiService.getReminderLogById(reminderLogId.toInt())
            .enqueue(object : Callback<ReminderLog> {
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (reminderLog != null) {
                            ...
                            Log.d(
                                ...
                                "Recordatorio obtenido con éxito del servidor."
                            )
                        } else {
